...
**Hocus Pocus** is our winner with 5 points.
...
* The survey was completed 13 times, which is not very many times. We like when 
more people vote.
* **Hocus Pocus** won with 6 positive votes and 1 negative vote.
* The Craft got the most postive votes (7) but also received 3 negative votes,
knocking it to a tie for second place with Ocean's Eight (5 in favour, 1 
against)
* Many options were quite unpopular this week. All but the top three candidates
had negative scores
* Fast and the Furious, Speed, and Snatched tied for most negative votes 
received, with 5 each.