...
* **Venom 2** won with 8 votes in favour and 3 against.
* Gunpowder Milkshake came in second with 6 votes in favour and 4 against.
* Every other movie on the list got negative points.
* At -9, The Fugitive might have received the lowest score we've seen so far. 
As usual, however, I am not going to go back and check. The repo is public if 
anyone else wants to.
* Cooties received the fewest neutral votes (1) while Snakes on a Plane received
the most (6). No movie received a majority of its votes in the 'meh' category.
