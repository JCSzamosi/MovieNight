...
* The survey was completed 12 times. Low voter numbers make ties more likely
* **Hotel Transylvania** won with four votes in favour and two against
* Starship Troopers and Best in Show tied for second place. Best in Show 
received fewer negative (and positive) votes, so it will be our emergency 
backup movie
* This was not a very popular slate. four of our movies had negative scores and
only three had positive scores. 
* All but one film (Starship Troopers) had at least 50% of its votes in the
'meh' category
* Nobody wanted to see Confess, Fletch, but very few people didn't want to see
it either.
* Exactly one person wanted to see Spirited.
...
**Hotel Transylvania** wins with 2 points!
