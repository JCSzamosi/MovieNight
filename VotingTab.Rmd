...
* The survey was completed 11 times. Low voter numbers make ties more likely.
* **The Great Muppet Caper** won with four votes in favour and none against
* Day Shift will be our emergency backup movie, just in case **The Great Muppet Caper** is too problematic and we need a safer option
* Four movies tied for fourth place
* No movies had zero votes in favour, but three (Space Jam, T2, and Lightyear) 
only had one positive vote each.
...
**The Great Muppet Caper** wins with four points!
