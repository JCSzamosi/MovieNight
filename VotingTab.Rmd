...
* The survey was completed 12 times. As usual, engagement is reduced on 
specialty weeks.
* **Class Action Park** won with 7 votes in favour and one against
* Zipper came in second with 5 votes in favour and one against; however, due to
technical difficulties our backup movie will be Bob Ross
* Bob Ross was the only movie that no one voted against.
* With the exception of Class Action Park, all movies received a plurality of 
their votes in the 'meh' category
...
**Class Action Park** wins with 6 points!
