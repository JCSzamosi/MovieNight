...
* The survey was completed 18 times. The tabulation committee thanks you for 
your particiption in the democratic process.
* **Burn after Reading** won with 10 votes in favour and three against. This
means **Burn after Reading** received a majority of its votes in the positive
category.
* War Games came in second with 8 votes in favour and 2 against.
* Only two movies (Turbo Kid and Tracers) received negative scores. Seven people
were strongly opposed to Tracers.
* Apathy won the day for three movies: The Net, Batteries not Included, and 
Robocop all received the majority of their votes in the 'meh' category.
...
# devtools::load_all('~/Work/aftersl1p')
theme_set(theme_bw())
...
**Burn After Reading** wins with 7 points!
