...
* **Mars Attacks** won with 5 votes in favour and 1 against
* Be Cool also received 5 positive votes, but it had 3 against, earning it 
second place
* Voting was less clean this week, with lower correlation between positive and
negative votes than some weeks
* Only one person wanted to see Renaissance Man. The 'meh' category for
Renaissance Man was also the only category with a majority of votes (7/12)
* Matilda generated the most controversy, with the fewest 'meh' votes and 
almost equal numbers of positive and negative votes.
...
**Mars Attacks** wins with 4 points!
