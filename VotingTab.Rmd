...
* **Tucker and Dale Vs. Evil** won with 8 votes in favour and 1 against
* If the movie about teenagers dying in the woods is too upsetting, we can 
always switch to an opera about vital organs being repossessed from the poor.
* This is one of our least negative weeks in a while, with only three movies' 
scores going into negative numbers.
* Most movies also did not have a plurality of their votes in the 'meh' category
Way to be entergaged with the process, voters!
...
**Tucker And Dale Vs. Evil** and Repo: A Genetic Opera tied with 7 points each.
We will be watching **Tucker And Dale Vs. Evil**.
