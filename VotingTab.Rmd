...
* **R.I.P.D** won with 9 votes in favour and 3 against
* A majority of movies (5) received 'meh' for the majority of their votes
* We had three movies go into negative points this week, with The Producers
receiving only a single vote in favour
* Our least-unpopular movies were Super Mario Bros. and Speed, each of which
received only a single vote against.
