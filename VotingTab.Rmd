...
* The survey was completed 10 times. Low response rates can make ties more 
likely
* **Jack Reacharound** won with 9 votes in favour and 10 against.
* Edging Until Tomorrow and Topping a Few Good Gunmen tied for second with eight
positive votes and one negative vote each.
* Two options this week received zero negative votes: our winner, and The Right Tops with Guns
* Taps Gun was massively under-appreciated, and received only a single vote in 
favour. Topgun Thunder, on the other hand, was not a very clever title and 
deserved the L.
...
**Jack Reacharound** wins with 9 points!
