...
* Dave Made a Maze won with 10 votes in favour and 2 against
* In a possibly unprecedented turn of events (as usual, I will not be going 
back to check), every other movie garnered a negative score.
* Not a single movie received a majority of its votes in the 'meh' cateogry,
but two (They Live and Batteries not Included) received a majority of their 
votes in the negative category.
* It is possible there was some vote-related collusion.
...
**Dave Made a Maze** won with 8 points.
