...
Legally Blonde and Romy and Michele's High School Reunion have tied for 
first place. Our benevolent dictator has chosen **Legally Blonde** on the basis 
of his preference for doggos.
...
You can download a .png of the plot [here](./current_week.png).

## Executive Summaries Go At the Bottom

* The survey was completed 17 times, and all movies were ranked each time.
* Romy and Michele's High School Reunion is tied for first place with Legally
Blonde, at 13 positive votes and 0 negative votes each.
* There were three movies that garnered negative votes: Tremors and Twister with 
one down-vote each, and Babe 2 with two.
* Beetlejuice and Babe 2 were tied for fewest positive votes, but Twister and
Babe 2 both scored below Beetlejuice because of their negative votes.
