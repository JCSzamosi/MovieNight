...
* **Jennifer's Body** won with 10 votes in favour and 3 against.
* Jennifer's Body was also the only film to get the majority of its votes in the
positive category.
* Only one other movie (Queen of the Damned) got a majority in any category. 
* Most movies had a fairly even distribution of votes, indicating high voter 
interest (positive or negative) in all of the movies
* Anaconda and The Thing tied for last, but The Thing garnered more interest 
overall
...
**Jennifer's Body** wins with 7 points.
