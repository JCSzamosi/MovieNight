...
* **Wag the Dog** won with 5 votes in favour and none against. It was the only 
movie this week with zero no votes.
* Our emergency backup movie will be Drive Away Dolls, with four votes in favour
and one against
* The number of yes votes is very strongly inversely correlated with the number 
of no votes
* Nobody wanted to see Coming 2 America
* Queenpins broke the monotonically decreasing trend in yes votes
...
**Wag the Dog** wins with 5 points!
