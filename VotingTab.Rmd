...
* **Throw Momma From the Train** won with eight votes in favour and two against.
* Our emergency backup movie will be Encanto, with a score of 3.
* Half of our movies received negative scores, with the lowest score going to
The Transporter, which no one wanted to see.
* One person wanted to see Smokey and the Bandit
* There were relatively few 'meh' votes this week
...
**Throw Momma From the Train** wins with 6 points!
