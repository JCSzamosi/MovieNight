...
**Empire Records** wins with 8 points.
...
* **Empire Records** won with 9 votes in favour and 1 against.
* We had a fairly well-liked suite of candidates this week, with 6 out of 8
candidates receiving 3 or fewer downvotes.
* The noteable exception is JCVD which, with 3 votes in favour and 9 against, 
has received our biggest negative score to date (probably; I will not being
going back to check).