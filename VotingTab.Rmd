...
* **Dogma** won in a landslide, with 11 votes in favour an 0 against, more than
doubling its runner up's point total.
* Cruel Intentions came in second, with 8 votes in favour and 3 against
* American Pie came in dead last with -4 points
* There was a strong spread in the result, with half of the candidates receiving
positive scores and half receiving negative scores.
* Orgazmo received a positive score.
* No movie received a majority of its votes in the 'meh' category, and no movie
received a majority of its votes in any category except for **Dogma**
