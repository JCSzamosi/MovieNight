...
* The survey was completed 11 times. Close call for the pig this week.
* **Horns** won with 6 votes in favour and 3 against.
* Swiss Army Man can in second with 4 votes in favour and 2 against.
* Engagement was high this week, despite low participation. Only one movie 
garnered a majority of its votes in the 'meh' category.
* Cooties received the most interest overall, with only a single 'meh' vote.
* Every single movie received at least one vote in favour, which was not a given
with this week's list
* Every movie received at least two votes against
