...
* **Chicago** won with 5 votes in favour and 3 against
* Gunpowder Milkshake came in second with 3 votes in favour and 2 against.
* Apathy ruled the day this week, with fully half of the options receiving
a majority of their votes in the 'meh' category
* Three of those four (Gunpowder Milkshake, Trading Places, and Layer 
Cake) received a full two thirds of their votes in the 'meh' category.
* Every single movie received a _plurality_ of its votes in the 'meh' 
category, and the smallest number of votes in that category was 7, nearly 
half.
