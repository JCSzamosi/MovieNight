...
* **Wild Wild West** and Robin Hood: Men In Tights tied with 6 votes each in 
favour and 2 each against.
* Our benevolent dictator has decreed that we will watch **Wild Wild West**, 
with Men in Tights for backup
* Votes were well split among categories for each movie, with only one movie
(The Kitchen) receiving a majority of its votes in any category (meh).
* Night at the Museum, Terminator 2, Wayne's World, and FAQ about Time Travel 
all received exactly half of their votes in the 'meh' category
* No movie was particularly more controversial than any other movie
...
**Wild Wild West** and Robin Hood: Men in Tights tied with 4 points each.
