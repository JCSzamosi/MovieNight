...
* **RescuersDownUnder** won with six votes in favour and two against
* Pushing Tin will be our emergency backup movie, just in case **Rescuers Down Under** is too problematic and we need a safer option
* Three movies tied for fourth place
* No movies had zero votes in favour, but only one person wanted to see the 
...
**Rescuers Down Under** wins with four points!
