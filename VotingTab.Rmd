...
* **Air Force One** won with six votes in favour and none against.
* Poseidon will be our emergency backup movie with three votes in favour and one
against.
* No movie other than our winner got more than three votes in favour. Most of
the variation in scores comes from the different number of negative votes
* Only one person wanted to see In The Line of Fire, while eight people did 
_not_ want to see Das Boot.
...
**Air Force One** wins with six points.
