...
* The survey was completed 11 times. Small numbers does tend to lead to ties.
* **Ronin** and Lego Batman tied for first place, but fewer people voted against
**Ronin**, which is how we default to breaking ties.
* Independence Day and Lego Batman both receive 6 votes in favour, but 
Independence Day got one additional vote against.
* Only one person wanted to watch Monkey Warfare
* Lego Batman and ID both had a majority positive votes, while War Games,
The Sure Thing, and Monkey Warfare all got a majority 'meh' votes. No movie
got a majority negative votes.
...
**Ronin** and Lego Batman tied for first place, with 4 points each. Our 
benevolent dictator has decreed that we will be watching Ronin.
