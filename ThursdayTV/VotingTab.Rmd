Thursday Night TV Voting
========================

* The survey was completed 7 times
* **The Expanse** won with 5 votes in favour and 1 against
* There was a perfect 3-way tie for second place
* Bridgerton came in last with an equal number of positive and negative votes
* Leverage garnered the least interest in either direction.
...
setwd('~/Projects/MovieNight/ThursdayTV')
library(tidyverse)
library(lubridate)
...
ranklevs = c('I would NOT come to watch this show',
		  'I do not love this show but would still show up',
		  'I would REALLY LIKE to watch this show')
...
**The Expanse** wins with 4 points
