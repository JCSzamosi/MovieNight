...
* **Xanadu**, A Few Best Men, and Face/Off all received 4 votes in favour and 3
against, for a perfect three-way tie. We will be watching **Xanadu**, with 
A Few Best Friend as backup.
* No other movie had positive scores, and the mean of all scores is less than
zero
* All movies except Grease received a plurality of their votes in the 'meh' 
category
* Theme nights tend to have lower entergagement than non-theme nights
* Only one person wanted to see either of Very Excellent Mr Dundee and Two of
a Kind
...
**Xanadu**, A Few Best Men, and Face/Off tied for first place with a score of 1
point each. We will be watching **Xanadu**
