...
* The survey was completed 10 times. Please clap.
* **Baby Driver** won with 6 votes in favour and one against. 
* If it turns out that the movie with Kevin Spacey about the getaway driver is 
too problematic we will instead be watching 
  * *checks notes*

Deliverance

* Nobody wanted to see Cry Baby or The Babe
* Babylon got a very impressive -4 points, despite two brave people voting in
its favour
* An equally impressive three quarters of our options received negative scores
...
**Baby Driver** wins with 5 points!
