...
* The survey was completed 13 times. Low voter turnout makes ties more likely
* **The VelociPastor** wins with 6 votes in favour and 2 against
* Our emergency backup fillum will be History of the World, Part 1
* M3gan garnered the most interest in both directions, with only 3 'meh' votes
* Only one person wanted to see each of Tammy and the T-Rex and Raiders of the 
Lost Shark; however, Tammy and the T-Rex received substantially fewer downvotes
* Every movie had at least one vote in each category
...
**The VelociPastor** wins with 4 points!
